...
public class FriendsListAdapter extends RecyclerView.Adapter<FriendsListAdapter.MyViewHolder> {
    ...
    public FriendsListAdapter(DialogFragment fragment, List<FriendsData> datas) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.contactChk.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ((ShareLocationDialog)fragment).mSelectedContacts.add(userId);
                }else {
                    ((ShareLocationDialog)fragment).mSelectedContacts.remove(userId);
                }
                System.out.println("SELECTED CONTACTS : " + ((ShareLocationDialog)fragment).mSelectedContacts);
            }
        });
