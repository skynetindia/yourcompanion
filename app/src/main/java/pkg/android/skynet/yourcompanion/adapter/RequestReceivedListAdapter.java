...
public class RequestReceivedListAdapter extends ArrayAdapter<RequestReceivedData> {

    private List<RequestReceivedData> mData;
    private Fragment fragment;

    private SessionManager sessionManager;
    private YourCompanion yourCompanion;

    public RequestReceivedListAdapter(Fragment fragment, List<RequestReceivedData> datas) {
        super(fragment.getActivity(), R.layout.row_request_received);
        this.mData = datas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(R.layout.row_request_received, null);
        }
        ...
        ImageView acceptImg = (ImageView)view.findViewById(R.id.img_accpet);
        ImageView declineImg = (ImageView)view.findViewById(R.id.img_decline);
        ...
        acceptImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                acceptRequest(mData.get(position).getInvId(), position);
            }
        });

        declineImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
     ...
     * @param position
     */
    private void acceptRequest(String invId, final int position) {
        HashMap<String, String> user = sessionManager.getUserDetails();
        String userId = user.get(SessionManager.USER_ID);

        try{
            ReqResAPICallBacks reqResAPICallBacks = new ReqResAPICallBacks();
            reqResAPICallBacks.acceptRequest(fragment.getActivity(), new ReqRespCallBack() {
                @Override
                public void onResponse(Object resObj, String resMessage, String resCode) {
            ...
            }, userId, invId, Constants.NOTIFY_TYPE_FRIEND_ACCEPT, true);
        }catch (Exception e) {
            e.printStackTrace();
        }
    }
